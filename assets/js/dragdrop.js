...
var drag = {
	...
	arTargets : ['One', 'Two', 'Three', 'Four', 'Five', 'Six'],
	...
	keyboardDragDrop : function(objEvent)
	{
		...
		var arChoices = ['Fishing and Boat Licences', 'General Business Licences', 'Registration Processes', 'Laws and Regulations', 'Advisory Information', 'Support Information'];
